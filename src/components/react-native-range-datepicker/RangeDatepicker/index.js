...
export default class RangeDatepicker extends Component {
	...
	static defaultProps = {
		...
		selectedBackgroundColor: '#41BBB5',
		...
		infoContainerStyle: {marginRight: 20, paddingHorizontal: 20, paddingVertical: 20, backgroundColor: '#41BBB5', borderRadius: 20, alignSelf: 'flex-end'},
	...
	render(){
			return (
				<View style={{backgroundColor: '#fff', zIndex: 1000, alignSelf: 'center', width: '100%', flex: 1, marginTop: '3%'}}>
					{
						...
						// 		{
						// 			this.props.showClose && <Text style={{fontSize: 10}} onPress={this.props.onClose}>Close</Text>
						// 		}
						// 		{
						// 			this.props.showReset && <Text style={{fontSize: 10}} onPress={this.onReset}>Reset</Text>
						// 		}
						// 	</View>)
						// 	:
						// 	null
